        ...
        back_button.setOnClickListener({
            when(seq){ // 코틀린 switch 버젼
                ...
                7->{//순서가 7인 경우에는 집 전화번호 입력으로 돌아간다.
                    ...
                    kakao_address.visibility = View.INVISIBLE
                    ex_main.setText(null)
                    seq--
                    main_menu.startAnimation(anim_test)
                    ex_main.startAnimation(anim_test)
                ...
                8->{//순서가 8인 경우에는 주소 입력으로 돌아간다.
                    ...
                    all_input.setHint("세부정보를 입력하세요")
                    kakao_address.visibility = View.VISIBLE
                    all_input.visibility = View.VISIBLE
                    number_input.visibility = View.INVISIBLE
                    ex_main.setText(null)
                    seq--
...
//            }
        ...
        kakao_address.setOnClickListener({
...
//        }
        ...
        fun getAddress(zoneCode: String, roadAddress: String, buildingName: String) {
            ...
            CoroutineScope(Dispatchers.Default).launch {
                ...
                withContext(CoroutineScope(Dispatchers.Main).coroutineContext) {
                    ...
                    kakao_address.setText("($zoneCode) $roadAddress $buildingName")
    ...
    private val chromeClient = object : WebChromeClient() {
        ...
        override fun onCreateWindow(
            ...
            val dialog = Dialog(this@CreateIdActivity)
